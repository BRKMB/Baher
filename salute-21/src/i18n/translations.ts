...
export const translations = {
  en: {
    ...
    reserveSuccessScript: 'Ci vediamo',
    reserveSuccessTitle: 'Your table is reserved',
    reserveSuccessText:
      'Thank you — your evening at Salute 21 is confirmed. We cannot wait to welcome you.',
    reserveSuccessNote:
      'A confirmation is ready below. Please arrive within 15 minutes of your booking time.',
  ...
  pl: {
    ...
    reserveSuccessText:
      'Dziękujemy — wieczór w Salute 21 jest potwierdzony. Nie możemy się doczekać Twojej wizyty.',
    reserveSuccessNote:
      'Potwierdzenie znajdziesz poniżej. Prosimy o przybycie w ciągu 15 minut od godziny rezerwacji.',
