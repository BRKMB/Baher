...
export const translations = {
  en: {
    ...
    menuPageIntro:
      'Burgers, sides, Turkish specials, pizza from 12:00, breakfast, lunch sets, coffee and cold drinks.',
    ...
    at: 'at',
    cat_burgers: 'Burgers',
    cat_burgers_sub: 'Classic, crispy, cheddar & more',
    cat_pizza: 'Pizza',
    cat_pizza_sub: 'From 12:00 · Made by Easy Pizzy',
    cat_sides: 'Sides',
    cat_sides_sub: 'Fries, bites & shares',
    cat_turkish: 'Turkish specialties',
    cat_turkish_sub: 'Toast & meatball sandwich — with fries',
    cat_breakfast: 'Breakfast',
    cat_breakfast_sub: 'Eggs, avocado & fresh bowls',
    cat_lunch: 'Lunch menu',
    cat_lunch_sub: 'Set deals with drink',
    cat_hot_coffee: 'Hot coffee',
    cat_hot_coffee_sub: 'Espresso bar & tea',
    cat_cold_coffee: 'Iced coffee',
    cat_cold_coffee_sub: 'Chilled cups',
    cat_cold_drinks: 'Cold drinks',
    cat_cold_drinks_sub: 'Soft drinks, juice & zero beer',
  },
  pl: {
    ...
    menuPageIntro:
      'Burgery, dodatki, specjały tureckie, pizza od 12:00, śniadania, zestawy lunchowe, kawa i napoje zimne.',
    ...
    at: 'o',
    cat_burgers: 'Burgery',
    cat_burgers_sub: 'Klasyczne, chrupiące, cheddar i więcej',
    cat_pizza: 'Pizza',
    cat_pizza_sub: 'Od 12:00 · Made by Easy Pizzy',
    cat_sides: 'Dodatki',
    cat_sides_sub: 'Frytki, przekąski i do dzielenia',
    cat_turkish: 'Specjały tureckie',
    cat_turkish_sub: 'Tosty i kanapka z klopsikami — z frytkami',
    cat_breakfast: 'Śniadania',
    cat_breakfast_sub: 'Jajka, awokado i świeże miski',
    cat_lunch: 'Menu lunchowe',
    cat_lunch_sub: 'Zestawy z napojem',
    cat_hot_coffee: 'Kawa gorąca',
    cat_hot_coffee_sub: 'Bar espresso i herbata',
    cat_cold_coffee: 'Kawa mrożona',
    cat_cold_coffee_sub: 'Schłodzone kawy',
