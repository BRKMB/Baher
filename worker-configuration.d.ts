/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 48a42d9565e0b53d2e17ab3ef608bd0c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_PASSWORD">> {}
}
