/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2874d34f492a93b7b886d3dc071e1856)
// Runtime types generated with workerd@1.20260721.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SITE_PASSWORD: "777";
	RESTORE_PASSWORD: "333";
	STORE: DurableObjectNamespace<import("./src/index").ListingsStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ListingsStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_PASSWORD" | "RESTORE_PASSWORD">> {}
}
